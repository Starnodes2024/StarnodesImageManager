...
Implementation of the direct "All Images" view with pagination
"""

import logging
from PyQt6.QtWidgets import QApplication, QMessageBox

logger = logging.getLogger("StarImageBrowse.ui.view_all_images")

def add_view_all_images_to_main_window(main_window):
    """Add view_all_images method to the main window
    
    Args:
        main_window: The main window instance
    """
    # Define the view_all_images method
    def view_all_images(self):
        ...
        try:
            ...
            # Make sure we have the database extension methods
    ...
    # Add the method to the main window
    import types
    main_window.view_all_images = types.MethodType(view_all_images, main_window)
    
    # Ensure DB extensions are loaded
    if not hasattr(main_window.db_manager, 'get_all_images_count'):
        from src.database.db_operations_extension import extend_db_operations
        extend_db_operations(main_window.db_manager)
